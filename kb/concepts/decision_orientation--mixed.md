---
type: Concept
field: "decision_orientation"
value: "mixed"
status: analytical_vocabulary
hyp_semantics: pending_expert_validation
---

# mixed

*decision_orientation* — Reserved value: genuinely split orientation within one Risposta (assign only after expert reading).
